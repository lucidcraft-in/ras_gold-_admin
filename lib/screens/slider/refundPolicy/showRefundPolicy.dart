...
class Showrefundpolicy extends StatefulWidget {
  @override
  _ShowrefundpolicyState createState() => _ShowrefundpolicyState();
}
      ...
      if (result != null) {
        ...
        if (downloadUrl != null) {
          ...
          QuerySnapshot existing =
              await FirebaseFirestore.instance.collection('refundPolicy').get();

          if (existing.docs.isNotEmpty) {
            // Update existing document
            await FirebaseFirestore.instance
                .collection('refundPolicy')
            ...
            // Add new document
            await FirebaseFirestore.instance.collection('refundPolicy').add({
              'name': downloadUrl,
              'fileType': fileType,
            });
          }
